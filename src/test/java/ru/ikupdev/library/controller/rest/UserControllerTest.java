...
public class UserControllerTest extends AbstractIntegrationTest {
    ...
    void givenGetUsersPageWithSpecifiedParameters_then200Ok() throws Exception {
        ...
        components.getMockMvc()
                ...
                .andExpect(jsonPath("$.data[0].roles[0].name", is("ROLE_USER")))
                .andExpect(jsonPath("$.data[0].roles[1].name", is("ROLE_ADMIN")))
                ...
                .andExpect(jsonPath("$.data[1].roles[0].name", is("ROLE_USER")));
    }
